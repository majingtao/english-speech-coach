...
@Schema(description = "管理后台 - AI 调用日志分页 Request VO")
@Data
public class AiCallLogPageReqVO extends PageParam {
    ...
    @Schema(description = "服务类型 llm / asr / tts", example = "1")
    ...
    @Schema(description = "调用日期（用于按天配额）")
