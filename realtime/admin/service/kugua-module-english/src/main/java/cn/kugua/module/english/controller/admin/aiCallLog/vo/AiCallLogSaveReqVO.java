...
@Schema(description = "管理后台 - AI 调用日志新增/修改 Request VO")
@Data
public class AiCallLogSaveReqVO {
    ...
    @NotEmpty(message = "服务类型 llm / asr / tts不能为空")
    ...
    @NotNull(message = "是否成功 1=成功 0=失败不能为空")
    ...
    @NotNull(message = "调用日期（用于按天配额）不能为空")
